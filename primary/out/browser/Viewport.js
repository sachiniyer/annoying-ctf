...
let Viewport = class Viewport extends Lifecycle_1.Disposable {
    constructor(_scrollLines, _viewportElement, _scrollArea, _bufferService, _optionsService, _charSizeService, _renderService, _coreBrowserService, themeService) {
        super();
        ...
        this.register((0, Lifecycle_2.addDisposableDomListener)(this._viewportElement, 'scroll', this._handleScroll.bind(this)));
...
Viewport = __decorate([
    ...
    __param(8, Services_1.IThemeService)
], Viewport);
