...
let DomRendererRowFactory = class DomRendererRowFactory {
    ...
    createRow(lineData, row, isCursorRow, cursorStyle, cursorX, cursorBlink, cellWidth, cols, cellMap) {
    ...
    _applyMinimumContrast(element, bg, fg, cell, bgOverride, fgOverride) {
        ...
        if (adjustedColor === undefined) {
            ...
            this._themeService.colors.contrastCache.setColor((bgOverride || bg).rgba, (fgOverride || fg).rgba, adjustedColor !== null && adjustedColor !== void 0 ? adjustedColor : null);
        }
        if (adjustedColor) {
