...
describe('InputHandler', () => {
    ...
    describe('reset text attributes (SGR 0)', () => {
        it('resets all attributes if there is no url', () => __awaiter(void 0, void 0, void 0, function* () {
            yield inputHandler.parseP('\x1b[30m\x1b[40m\x1b[4m');
            ...
            yield inputHandler.parseP('\x1b[m');
        ...
        it('resets all attributes except for the url', () => __awaiter(void 0, void 0, void 0, function* () {
            yield inputHandler.parseP('\x1b[30m\x1b[40m\x1b[4m');
            yield inputHandler.parseP('\x1b]8;;http://example.com\x1b\\');
            chai_1.assert.notEqual(inputHandler.curAttrData.fg, 0);
            chai_1.assert.notEqual(inputHandler.curAttrData.bg, 0);
